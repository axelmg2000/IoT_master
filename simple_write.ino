...
int ledPin = 8;
int limite = 60; // Se define un límite de pulso cardiaco, para levantar una bandera en caso de que se supere
...
void loop() {
  ...
  if(millis() >= timePM + 15000) {
    ...
    if((pulse * 4) > limite) {
      digitalWrite(ledPin, HIGH); // Se manda una señal "alta" en el puerto al que ledPiun hace referencia
